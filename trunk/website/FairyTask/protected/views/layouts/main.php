...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'任务板', 'url'=>array('/task')),
				...
				array('label'=>'用户中心 ', 'url'=>array('/uCenter/index'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'后台管理', 'url'=>array('/admin'), 'visible'=>!Yii::app()->user->isGuest),
			),
		)); ?>
	</div><!-- mainmenu -->
	<?php echo $content; ?>
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by 瑞泰科技.<br/>
