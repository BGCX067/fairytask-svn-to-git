package fairy.operation
{
	import flash.events.Event;
	
	import fairy.debug.Debug;
	import fairy.events.OperationEvent;
	
	
	[Event(name="child_operation_start",type="fairy.events.OperationEvent")]
	[Event(name="child_operation_complete",type="fairy.events.OperationEvent")]
	[Event(name="child_operation_error",type="fairy.events.OperationEvent")]
