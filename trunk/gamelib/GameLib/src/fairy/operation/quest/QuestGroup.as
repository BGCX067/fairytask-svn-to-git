package fairy.operation.quest
{
	import flash.events.EventDispatcher;
	import flash.utils.ByteArray;
	
	import fairy.util.data.BitArray;

	[Event(name="quest_start",type="fairy.operation.quest.QuestEvent")]
	[Event(name="quest_complete",type="fairy.operation.quest.QuestEvent")]
