package fairy.operation.load
{
	...
	import fairy.manager.FileCacherManager;
	import fairy.operation.RetryOper;
	import fairy.ui.controls.IProgressTargetClient;
	import fairy.util.Util;
	import fairy.util.data.LocalStorage;
	import fairy.util.text.URL;
	...
	public class LoadOper extends RetryOper implements IProgressTargetClient
	{
		 ...
		 * 使用Loader作为加载器的文件扩展名
		 */
		public static var LOADER_TYPE:Array = ["gif","png","jpg"];
