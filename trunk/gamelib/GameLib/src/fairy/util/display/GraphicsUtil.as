package fairy.util.display
{
	import flash.display.BitmapData;
	import flash.display.Graphics;
	import flash.geom.Point;
	
	import fairy.algorithm.bezier.Bezier;
	import fairy.parse.graphics.GraphicsBezier;
	import fairy.parse.graphics.GraphicsBitmapFill;
	import fairy.parse.graphics.GraphicsLine;
	import fairy.parse.graphics.GraphicsRect;
	import fairy.parse.graphics.GraphicsSector;
