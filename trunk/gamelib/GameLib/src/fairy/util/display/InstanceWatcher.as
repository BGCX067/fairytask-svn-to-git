package fairy.util.display
{
	...
	import fairy.events.InstanceEvent;

	[Event(name="instance_create",type="fairy.events.InstanceEvent")]
	[Event(name="instance_destory",type="fairy.events.InstanceEvent")]
	/**
