package fairy.display.bitmap
{
	...
	import fairy.events.MoveEvent;
	import fairy.events.ResizeEvent;
	import fairy.events.TickEvent;
	import fairy.parse.display.DrawParse;
	import fairy.parse.graphics.GraphicsBitmapFill;
	import fairy.util.Tick;
	import fairy.util.core.ClassFactory;
	import fairy.util.core.UniqueCall;
	import fairy.util.display.BitmapGrid9Util;
	import fairy.util.display.GraphicsUtil;
	
	[Event(name="update_complete",type="fairy.events.GEvent")]
	[Event(name="click",type="fairy.events.MoveEvent")]
	[Event(name="move",type="fairy.events.MoveEvent")]
	[Event(name="resize",type="fairy.events.ResizeEvent")]
