package fairy.display
{
	...
	import fairy.events.RepeatEvent;
	import fairy.events.TickEvent;
	import fairy.util.core.ClassFactory;
	import fairy.util.display.DisplayUtil;
	import fairy.util.display.Geom;
	
	[Event(name="add_repeat_item",type="fairy.events.RepeatEvent")]
	
	[Event(name="remove_repeat_item",type="fairy.events.RepeatEvent")]
