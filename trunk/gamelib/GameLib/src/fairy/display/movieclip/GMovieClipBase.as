package fairy.display.movieclip
{
	...
	import fairy.events.MovieEvent;
	import fairy.events.TickEvent;
	import fairy.util.Tick;
	import fairy.util.Util;
	import fairy.util.core.AbstractUtil;
	import fairy.util.core.Handler;

	[Event(name="movie_start",type="fairy.events.MovieEvent")]
	
	[Event(name="movie_end",type="fairy.events.MovieEvent")]
	
	[Event(name="movie_empty",type="fairy.events.MovieEvent")]
