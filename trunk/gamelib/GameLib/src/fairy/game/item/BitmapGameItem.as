package fairy.game.item
{
	...
	import fairy.game.item.collision.ICollision;
	import fairy.game.item.sort.ISortCalculater;
	import fairy.game.layer.camera.ICamera;
	import fairy.game.layer.collision.client.ICollisionClient;
