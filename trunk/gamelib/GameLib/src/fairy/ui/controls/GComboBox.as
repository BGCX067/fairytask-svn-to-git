package fairy.ui.controls
{
	...
	import fairy.operation.effect.AlphaClipEffect;
	import fairy.skin.ComboBoxSkin;
	import fairy.ui.UIConst;
	import fairy.ui.containers.GList;
	...
	public class GComboBox extends GButton
	{
		 ...
		 * 列表实例
		 */
		public var list:fairy.ui.containers.GList;
		...
		public override function setContent(skin:*, replace:Boolean=true) : void
		{
			...
			list = new fairy.ui.containers.GList(content[listField],true,UIConst.VERTICAL);
