package fairy.ui.controls
{
	...
	import fairy.display.filter.FilterProxy;
	import fairy.events.TickEvent;
	import fairy.ui.UIConst;
	import fairy.ui.scroll.GScrollPanel;
	import fairy.ui.scroll.IScrollContent;
	import fairy.ui.scroll.ScrollTextContent;
	import fairy.util.easing.Circ;
	import fairy.util.easing.TweenEvent;
	import fairy.util.easing.TweenUtil;
	
	
	[Event(name="tween_start",type="fairy.util.easing.TweenEvent")]
	[Event(name="tween_end",type="fairy.util.easing.TweenEvent")]
	[Event(name="tween_update",type="fairy.util.easing.TweenEvent")]
	/**
	 * 滚动条 
	 * 
	 * 标签规则：和Silder相同
