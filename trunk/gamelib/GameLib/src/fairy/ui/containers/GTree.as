package fairy.ui.containers
{
	...
	import fairy.util.data.XMLUtil;
	
 	[Event(name="tree_click",type="fairy.events.TreeEvent")]
 	[Event(name="tree_close",type="fairy.events.TreeEvent")]
 	[Event(name="tree_open",type="fairy.events.TreeEvent")]
 	[Event(name="tree_opening",type="fairy.events.TreeEvent")]
	/**
	 * 树
	 * 
